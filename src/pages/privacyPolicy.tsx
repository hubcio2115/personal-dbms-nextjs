  ...
  return (
    <MainLayout className="flex-col items-center pt-5 text-primary-content">
      ...
      <article className="prose">
        ...
        <p>
          Hubert inc. operates the{' '}
          <Link
            href="https://projektprogramistyczny-hubcio2115.vercel.app/"
            className="text-base-content"
          >
            https://projektprogramistyczny-hubcio2115.vercel.app/
          </Link>{' '}
        ...
        <p>
          ...
          anyone decided to use our Service, the Personal DBMS website.
        </p>
